...
import { fixStScrollViewScrollbarOverflow } from "./utility.js"
import { GnomeContext } from "./gnome.js"
...
const ClearButton = GObject.registerClass(
...
const Header = GObject.registerClass(
...
const NativeControl = GObject.registerClass(
...
export const NotificationBox = GObject.registerClass(
    class Notification extends St.BoxLayout {
        _init(options) {
            super._init({
                vertical: true,
            })

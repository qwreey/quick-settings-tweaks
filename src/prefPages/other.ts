...
import { baseGTypeName, Group, Row, SwitchRow, Button, ToggleButtonRow, UpDownButton } from "../libs/prefComponents.js"
...
export const otherPage = GObject.registerClass({
	...
	constructor(settings: Gio.Settings) {
		...
		Group({
			...
			Group({
				...
				headerSuffix: Button({
					...
					action() {
						settings.set_strv("system-items-order", DefaultOrder)
					},
				}),
		...
		this.connect("destroy", ()=>settings.disconnect(orderConnection))
